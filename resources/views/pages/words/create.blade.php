...
@push('scripts')
    ...
    <script src="{{ asset('js/page/words/storage-helper.js') }}?v=1.1.2"></script>
    <script src="{{ asset('js/page/words/word-crud.js') }}?v=1.1.2"></script>
    <script src="{{ asset('js/page/words/words-page.js') }}?v=1.1.2"></script>
    <script src="{{ asset('js/page/words/autocomplete.js') }}?v=1.1.2"></script>
@endpush
