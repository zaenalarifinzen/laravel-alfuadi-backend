        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    On this page you can edit product from product list.
                </p>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('products.update', $product->id) }}" method="post"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea class="form-control @error('description') is-invalid @enderror" data-height="150" name="description">{{ old('description', $product->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            {{-- @if ($product->image)
                                                <div class="mt-2">
                                                    <img src="{{ asset('images/products/' . $product->image) }}"
                                                        alt="Current Image" width="150" class="img-thumbnail">
                                                </div>
                                            @endif --}}
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    @vite(['resources/js/page/features-post-create.js'])
@endpush
