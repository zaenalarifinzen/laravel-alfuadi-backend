                                ...
                                <form action="{{ route('kalimat.update', $kalimat) }}" method="POST" novalidate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            name="id" value="{{ $kalimat->id }}" readonly>
                                        @error('id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control arabic-text @error('kalimat_ar') is-invalid @enderror"
                                            name="kalimat_ar" value="{{ $kalimat->kalimat_ar }}" required>
                                        @error('kalimat_ar')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control arabic-text @error('kalimat_ar_musyakal') is-invalid @enderror"
                                            name="kalimat_ar_musyakal" value="{{ $kalimat->kalimat_ar_musyakal }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('kalimat_in') is-invalid @enderror"
                                            name="kalimat_in" value="{{ $kalimat->kalimat_in }}" required>
                                        @error('kalimat_in')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
